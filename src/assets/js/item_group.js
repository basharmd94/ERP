...
$(function () {
    ...
    $('#addItemGroupForm').on('submit', function (e) {
        ...
        // Send AJAX request to create item group       
        $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 'success') {
                            Swal.fire({
                                icon: 'success',
                                title: 'Deleted!',
                                text: 'Item group has been deleted successfully.',
                                customClass: {
                                    confirmButton: 'btn btn-success'
                                }
                            });
    ...
    // Edit Item Group Form Submission
    $('#editItemGroupForm').on('submit', function(e) {
        e.preventDefault();
        
        var itemGroupCode = $('#editItemGroupCode').val();
        var newItemGroupName = $('#editItemGroupName').val().trim();
        ...
        updateItemGroup(itemGroupCode, newItemGroupName);
    });

    // Function to update item group
    function updateItemGroup(itemGroupCode, newItemGroupName) {
        var csrfToken = $('[name=csrfmiddlewaretoken]').val();
        ...
        $.ajax({
            ...
            type: 'POST',
            data: {
                'item_group_description': newItemGroupName,
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error!',
                        text: response.error || 'Unknown error occurred while updating the item group.',
                        customClass: {
                            confirmButton: 'btn btn-primary'
                        }
                    });
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Error!',
                        text: response.error || 'Unknown error occurred while deleting the item group.',
                        customClass: {
                            confirmButton: 'btn btn-primary'
                        }
                    });
