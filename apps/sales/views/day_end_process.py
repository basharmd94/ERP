...
def aggregate_sales_data(zid, xdate):
    """
...
def insert_gl_header(zid, voucher, xdate, session_user):
    """
...
def insert_gl_detail_row(cursor, ztime, zid, xvoucher, xrow, xacc,
...
def execute_day_end_process(zid, xdate, session_user):
    ...
    try:
        ...
        duplicate_check = check_duplicate_processing(zid, xdate)
        ...
        # Step 2: Aggregate data from opordnview
        aggregated_data = aggregate_sales_data(zid, xdate)
        ...
        # Step 4: Insert GL header
        insert_gl_header(zid, voucher, xdate, session_user)

        # Step 5: Insert GL details
        insert_gl_details(zid, voucher, xdate, aggregated_data)
...
def create_day_end_process(request):
    ...
    try:
        ...
        result = execute_day_end_process(current_zid, xdate, session_user)
