...
from .views.pos_sales import pos_complete_sale
...
from .views.day_end_process import create_day_end_process, delete_day_end_process
...
from .views.modules import (
    DayEndProcessView, PosSalesView, SalesListView, SalesReturnView, SalesReturnListView, SalesReportsView
    )
...
urlpatterns = [
    ...
    # |   Sales Menu List         |
    # +--------------------------+
    path("pos-sales/", PosSalesView.as_view(), name="pos-sales"),
    # Sales List
    path("sales-list/", SalesListView.as_view(), name="sales-list"),
    # Day End Process
    path("day-end-process/", DayEndProcessView.as_view(), name="day-end-process"),
